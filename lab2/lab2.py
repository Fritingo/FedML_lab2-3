...
def add_args(parser):
    ...
    parser.add_argument('--dataset', type=str, default='shakespeare', metavar='N',
    ...
    parser.add_argument('--client_num_in_total', type=int, default=30, metavar='NN',
...
if __name__ == "__main__":
    ...
    dummy_opt = torch.optim.Adam(copy.deepcopy(model).parameters(), lr=args.lr)
    dummy_scheduler = torch.optim.lr_scheduler.StepLR(optimizer=dummy_opt, 
                                                    step_size = args.comm_round/3,
                                                    gamma = 0.7)
